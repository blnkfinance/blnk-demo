...
const TABLE_HEADERS = [
  { label: "Product", width: "240px", align: "left" as const },
  { label: "Rate", width: "160px", align: "left" as const },
  { label: "Created at", width: "200px", align: "left" as const },
        ...
        <thead>
          <tr>
            {TABLE_HEADERS.map((header, index) => (
              <th
                key={header.label}
                className={`border-b border-platform-stroke py-3 text-[10px] font-medium uppercase leading-3 tracking-[0.5px] text-platform-primary-text font-pastiche text-left ${
